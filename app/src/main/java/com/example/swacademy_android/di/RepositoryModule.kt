...
import com.example.swacademy_android.data.repository.PointRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindPointRepository(mypageRepository: PointRepositoryImpl): PointRepository
